...
**Статус (2026-07-23):** ядро завершено (этапы 0–6) — вся политика в чистых
функциях `domain/`, покрытие ветвей 100 %, mutation ≥ 90 %; tracer bullet
проверен на песочнице HA 2026.5.4. Дальше — этап 7 (исполняющая обвязка).
...
Пройдены шаги 1–5: `task.md`, `TZ.md`, `SPEC.md`, `PLAN.md` и реализация ядра
(этапы 0–6). Актуальный статус и changelog — в [`PLAN.md`](PLAN.md).
