...
Постановка задачи (шаг 1 воркфлоу) уже лежит в [`docs/task.md`](docs/task.md),
архитектурные требования — в [`docs/TZ.md`](docs/TZ.md).

**Следующий шаг:** [`2-spec.md`](.ai/prompts/2-spec.md) → `SPEC.md`.

> ⚠️ Открытые вопросы, блокирующие шаг 5 (реализация по TDD), — в
> [`tooling.md`](.ai/rules/tooling.md) §2: целевой Python 3.14.2+ (на машине
> разработки 3.12.13) и среда для тестов, которым нужен пакет `homeassistant`.
