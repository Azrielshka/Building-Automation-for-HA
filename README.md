...
Этапы 0–9 реализованы и проверены на песочнице HA 2026.5.4:
...
Осталось: этап 10 — `hassfest`, quality-scale, финальный приёмочный чек-лист
(проверка неадмином, видимый свет на живом железе). Актуальный changelog — в
[`PLAN.md`](PLAN.md).
